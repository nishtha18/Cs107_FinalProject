...
for ( i in 1:length(years)) {
  url[i] <- paste0(url_base, years[i],"/games")
  print(url[i])
}
...
FifaWorldCup <- rbind(s2014, s2010, s2006, s2002, s1998, s1994, s1990, s1986, s1982, s1978, s1974, s1970, s1966, s1962, s1958, s1954, s1950, s1934, s1930)
